...
public class Difficulty {
	...
	public Difficulty(String name, int agility, int organization, int wisdom, int windlessness, int courage,
			int strength, int animalF, int orientation, int justice) {
		this.name = name;
	...
	public String toString() {
		return (this.name + "\n" + (this.agility != 0 ? "Agility : " + this.agility + "\n" : null)
				+ (this.organization != 0 ? "Organization : " + this.organization + "\n" : null)
				+ (this.wisdom != 0 ? "Wisdom : " + this.wisdom + "\n" : null)
				+ (this.windlessness != 0 ? "Windlessness : " + this.windlessness + "\n" : null)
				+ (this.courage != 0 ? "Courage : " + this.courage + "\n" : null)
				+ (this.strength != 0 ? "Strength : " + this.strength + "\n" : null)
				+ (this.animalF != 0 ? "Animal Friendly : " + this.animalF + "\n" : null)
				+ (this.orientation != 0 ? "Orientation : " + this.orientation + "\n" : null)
				+ (this.justice != 0 ? "Justice : " + this.justice + "\n" : null));
	}
