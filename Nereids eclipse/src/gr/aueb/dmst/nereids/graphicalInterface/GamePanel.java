...
/**
 * GamePlay Panel This is the panel that displays the main game of "Nereids",
 * where the player controls the boat using the arrow keys and will have to
 * choose between 3 obstacles to encounter each time for 8 times in order to
 * reach Sicily.
 */
